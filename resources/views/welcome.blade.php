...
<body class="bg-gray-50">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <select id="letterType" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                ...
                <div id="jaccardResults" class="space-y-3">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition duration-200">
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <span class="px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full">85% Match</span>
                        </div>
                        <p class="text-sm text-gray-600 mb-2">Nomor: 001/ARSIP/2024 | Tanggal: 15 Januari 2024</p>
                        <p class="text-sm text-gray-700">Surat masuk mengenai undangan rapat koordinasi bulanan...</p>
                    </div>
                    
                    <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition duration-200">
                        <div class="flex justify-between items-start mb-2">
                            <h4 class="font-medium text-gray-800">Surat Edaran</h4>
                            <span class="px-2 py-1 bg-yellow-100 text-yellow-800 text-xs rounded-full">65% Match</span>
                        </div>
    ...
    <footer class="bg-gray-800 text-white py-8 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <p>&copy; 2024 Sistem Arsip Digital. All rights reserved.</p>
            </div>
        </div>
    </footer>
    ...
    <script>
        function performSearch() {
            ...
            jaccardResults.innerHTML = '<div class="text-center py-4"><i class="fas fa-spinner fa-spin text-2xl text-gray-400"></i></div>';
            cosineResults.innerHTML = '<div class="text-center py-4"><i class="fas fa-spinner fa-spin text-2xl text-gray-400"></i></div>';
