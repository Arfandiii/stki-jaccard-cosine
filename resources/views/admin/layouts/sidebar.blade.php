<!-- Sidebar -->
<aside
    class="w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-linear-to-r from-purple-600 to-blue-500">
    <!-- open sidebar button -->
    <div
        class="max-toolbar translate-x-24 scale-x-0 w-full -right-6 transition transform ease-in duration-300 flex items-center justify-between border-4 border-white bg-linear-to-r from-blue-500 to-purple-600 absolute top-2 rounded-full h-12">
        <div class="pl-4 items-center space-x-2 ">
            <div class="hover:cursor-pointer text-white hover:text-zinc-900">
                <a href="#">
    ...
    <div class="max hidden text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
        ...
        <form action="#" method="post" class="border-t-2 border-blue-700 pt-2">
            @csrf
