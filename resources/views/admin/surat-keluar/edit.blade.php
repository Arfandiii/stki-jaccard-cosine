        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-linear-to-r from-blue-500 to-indigo-600 rounded-t-xl px-6 py-5 shadow-lg">
                <div class="flex items-center space-x-3 text-white">
                    ...
                    <h2 class="text-2xl font-bold tracking-wide">Edit Surat Keluar</h2>
                </div>
                <p class="text-orange-100 text-sm mt-1">Perbarui data surat keluar yang sudah ada.</p>
            </div>

            <!-- Body kartu -->
            <div class="bg-white rounded-b-xl shadow-lg px-6 py-6">
                <form action="{{ route('admin.surat-keluar.update', $surat->id) }}" method="POST"
                    ...
                    <div class="grid md:grid-cols-2 gap-5">
                        ...
                        <!-- Tujuan Surat -->
                        <div>
                            <label class="block text-sm font-semibold text-gray-700">Tujuan Surat</label>
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-semibold text-gray-700">Ganti File PDF (kosongkan bila tidak
                                diganti)</label>
                            @if ($surat->file_path)
                                <p class="text-xs text-gray-500 mb-2">File saat ini: <a
                                        href="{{ Storage::url($surat->file_path) }}" target="_blank"
                                        class="text-blue-600 underline">Lihat PDF</a></p>
                            @endif
