        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-linear-to-r from-blue-500 to-indigo-600 rounded-t-xl px-6 py-5 shadow-lg">
                <div class="flex items-center space-x-3 text-white">
                    ...
                    <h2 class="text-2xl font-bold tracking-wide">Tambah Surat Keluar</h2>
                </div>
                <p class="text-blue-100 text-sm mt-1">
                    Isi form berikut untuk mencatat surat keluar baru.
                </p>
            </div>
            ...
            <div class="bg-white rounded-b-xl shadow-lg px-6 py-6">
                ...
                <form action="{{ route('admin.surat-keluar.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid md:grid-cols-2 gap-5">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="mt-2 flex items-center justify-center w-full">
                                <label
                                    class="flex flex-col w-full h-32 border-2 border-dashed border-blue-300
                                        rounded-lg cursor-pointer hover:bg-blue-50 hover:border-blue-400 transition">
                    ...
                    <div class="flex justify-end space-x-3 mt-8">
                        ...
                        <button type="submit"
                            class="px-6 py-2.5 rounded-lg text-white font-semibold
