<div
    class="hover:cursor-pointer hover:ml-4 w-full text-white hover:text-blue-200 font-medium bg-blue-600 p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
    @switch($iconType)
        @case('dashboard')
