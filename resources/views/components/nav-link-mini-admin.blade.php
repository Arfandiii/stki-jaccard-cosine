<div
    class="hover:cursor-pointer hover:outline hover:ml-4 justify-end pr-5 text-white hover:text-blue-200 w-full bg-blue-600 to-purple-600 p-3 rounded-full transform ease-in-out duration-300 flex">
    @switch($iconType)
        @case('dashboard')
        ...
        @case('history')
            <svg viewBox="0 0 512 512" class="size-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path
